...
def to_mod_list(employee_list):
   ...
   # Implement the to_mod_list() function by using the map() function 
   # to apply mod() to all elements within employee_list. Assign the result of it 
   # to a new variable called map_emp. Convert map_emp to a list and return it.
...
def generate_usernames(mod_list):
   ...
   """
   ### WRITE SOLUTION CODE HERE
   underscore_list = [x.replace(" ", "_") for x in mod_list]
